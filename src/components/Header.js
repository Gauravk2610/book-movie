    ...
    return (
        <header>
            <div className='flex justify-center header'>
                <div className='mx-6 lg:max-w-7xl  w-full h-20 flex justify-between items-center'>
                    <Link to={`/`}>
                        <div className='text-xl sm:text-3xl '>Book-Movie</div>
                    </Link>
                    <div className='hidden sm:flex items-center mr-auto mx-6 border-[#df0e62] rounded-lg py-2 px-3 border-2 sm:max-w-lg sm:w-full'>
                        <SearchIcon className='w-5 h-5 text-white' />
                        <input className='hidden sm:flex outline-none focus:ring-0 ml-3 text-white bg-inherit w-full' type="text" placeholder='Search for Movies' />
                    </div>
            ...
            <div className="hidden sm:flex justify-center header-links">
